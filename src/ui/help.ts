...
const SECTIONS: [string, string[]][] = [
  ...
  [
    ...
    [
      'Six levels, one to six stars. Each has two pools: Classic plays hand-picked grids, while New generates grids deterministically from their level and number.',
